/*
 * Created: Jul 15, 2004
 * File version: $Id: ArticleSource.java,v 1.1 2005/05/03 23:34:41 jaknowlden Exp $
 * 
...
public interface ArticleSource {
  ...
  /**
   * Obtain an Article's contents as a Reader instance. Should never return null.
   * @param articleName
   * @throws IOException
   * @throws ArticleNotFoundException
   * @return Reader pointing to Article's contents
   */
