/*
 * Created: Oct 23, 2004
 * File version: $Id: FileSystemArticleSource.java,v 1.1 2005/05/03 23:34:39 jaknowlden Exp $
 * 
 ...
 */
public class FileSystemArticleSource implements ArticleSource {
  ...
  public Reader getArticleReader(String articleName) throws IOException, ArticleNotFoundException {
    try {
      return new FileReader(articleName);
