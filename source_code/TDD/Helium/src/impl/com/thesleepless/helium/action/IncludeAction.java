/*
 * Created: Jul 15, 2004
 * File version: $Id: IncludeAction.java,v 1.1 2005/05/03 23:34:41 jaknowlden Exp $
 * 
...
public class IncludeAction extends AbstractAction {
  ...
  private static final String ArgArticle = "article";
  ...
  public void service(Article article, HeliumContext context) throws HeliumException {
    checkRequiredArgument(article, ArgArticle);

    Map actualDataMap = context.getDataMap();
    context.setDataMap(new HashMap(actualDataMap));
    getBody(article, context);
    parseArticle(getArgumentValue(article, ArgArticle), context);
    context.setDataMap(actualDataMap);
  }
