...
-->
<project name="Commons IO" xmlns:jacoco="antlib:org.jacoco.ant" default="jar" basedir=".">
...
<!-- ========== Unit Test Targets ========================================= -->
  ...
  <jacoco:coverage destfile="jacocoReport/jacoco.exec">
    <junit printsummary="true" showoutput="true" Debug="true" fork="yes" forkmode="once" haltonfailure="${test.failonerror}">
      <classpath refid="test.classpath"/>
      <formatter type="plain" usefile="true" />
      <!-- If test.entry is defined, run a single test, otherwise run all valid tests -->
      <test name="${test.entry}" if="test.entry"/>
      <batchtest fork="true" todir="${build.home}/ant-reports" unless="test.entry">
