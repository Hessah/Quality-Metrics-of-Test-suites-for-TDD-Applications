...
public class TimeSeriesCollectionTest {
    ...
    public void testFindDomainBounds() {
        ...
        r = DatasetUtilities.findDomainBounds(dataset, visibleSeriesKeys, true);
        assertEquals(1199170800000.0, r.getLowerBound(), EPSILON);
        assertEquals(1230793199999.0, r.getUpperBound(), EPSILON);
        ...
        r = DatasetUtilities.findDomainBounds(dataset, visibleSeriesKeys, true);
        assertEquals(1199170800000.0, r.getLowerBound(), EPSILON);
        assertEquals(1293865199999.0, r.getUpperBound(), EPSILON);
