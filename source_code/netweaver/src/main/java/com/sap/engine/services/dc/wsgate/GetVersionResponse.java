...
public class GetVersionResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the _return value for this GetVersionResponse.
     * 
     * @return _return
     */
    ...
    /**
     * Sets the _return value for this GetVersionResponse.
     * 
     * @param _return
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://sap.com/2009/11/24/deployws", "getVersionResponse"));
