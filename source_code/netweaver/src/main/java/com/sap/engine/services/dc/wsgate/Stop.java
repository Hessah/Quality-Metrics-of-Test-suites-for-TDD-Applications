...
public class Stop  implements java.io.Serializable {
    ...
    /**
     * Gets the apps value for this Stop.
     * 
     * @return apps
     */
    ...
    /**
     * Sets the apps value for this Stop.
     * 
     * @param apps
     */
    ...
    /**
     * Gets the options value for this Stop.
     * 
     * @return options
     */
    ...
    /**
     * Sets the options value for this Stop.
     * 
     * @param options
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://sap.com/2009/11/24/deployws", "stop"));
