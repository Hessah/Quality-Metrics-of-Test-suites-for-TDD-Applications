...
public class StopAppCommand extends AppCommand {
	...
	public String execute() throws Exception {
		try {
			...
			if (app == null) {
				...
				server.getDeployManager().stop(new Application[] { app });
				return "Application stop triggered successfully. ";
			}
		} catch (NotAuthorizedException e) {
			return "Authorization failed: " + e.getMessage();
		} catch (CoreException e) {
			return "Application stop trigger failed: " + e.getMessage();
		} 
	}
